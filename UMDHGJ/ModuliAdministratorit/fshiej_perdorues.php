				...
				<!-- Main -->
					<div id="main">
						...
						<section id="first" class="main special">
								...
								<header class="major">
									<h2>Kërko të dhënat e përdoruesit për fshirje</h2>
								</header>
...
while($rreshti = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"fshiej_p.php?epid=$rreshti[epid]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";		
	}
