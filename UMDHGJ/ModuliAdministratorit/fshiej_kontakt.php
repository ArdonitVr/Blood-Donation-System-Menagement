						...
						<section id="first" class="main special">
	                         ...
	                         <tr>
	                          ...
	                          <td>
	                           ...
	                           <input type="text" name="p_kusht" id="p_kusht" value="%" placeholder="Subjektin ose Email-in" />
                              </td>
                              <td> 
                              <ul class="actions">
...
$sql = mysqli_query($lidh_fshiej_kontakt,
"CALL fshiej_kontakt('$p_kusht')"); 
while($rreshti = mysqli_fetch_array($sql)) { 		
		echo "<tr>";
		echo "<td>".$rreshti['Subjekti']."</td>";
		echo "<td>".$rreshti['Mesazhi']."</td>";
		echo "<td>".$rreshti['Email']."</td>";	
		echo "<td><a href=\"fshiej_kont.php?ID_Kontakti=$rreshti[ID_Kontakti]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini kontaktin?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";			
	}
