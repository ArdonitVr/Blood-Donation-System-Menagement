				...
				<!-- Main -->
					<div id="main">
						...
						<section id="first" class="main special">
										...
										<blockquote><h2 style="text-align: left;">Shto të dhënat e përdoruesit</h2>
											
										<form method="post" action="shtoP.php">
											<div class="row gtr-uniform">
												<div class="col-6 col-12-xsmall">
													<input type="text" name="emriperdoruesit" id="emriperdoruesit" value="" placeholder="Perdoruesi" />
												<br>
												<div class="col-6 col-12-xsmall">
												...
												<div class="col-12">
														<br>
													<ul class="actions">
														<li><input type="submit" name="shtoP" value="Shto" class="primary" /></li></ul>
											</div>
											</div>
										</form>
									</div>
